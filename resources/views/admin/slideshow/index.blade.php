...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card-body">
                @if (session('msg'))
                <p style="width: 100%;height: 60px; background:#c1b999;margin-top: 10px;padding-top: 15px;padding-left: 20px;border-radius: 4px"><span class="text-white">{{ session('msg') }}</span></p>
                      @endif
                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example" class="table table-hover dataTable" role="grid"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin.edit_slideshow', ['id' => $slideshow->id])}}"
                                            ...
                                            <a href="javascript:;"
                                                linkurl="{{route('admin.remove_slideshow', ['id' => $slideshow->id])}}"
