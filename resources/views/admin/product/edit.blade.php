...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="col-md-12">
                <form action="{{route('admin.edit_product', ['id' => $product->id])}}" method="post"
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    <img name="picture" id="" src="/{{$product->picture}}" width="100%" required=""
                                        aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-12 text-left">
                        ...
                        <a href="{{route('admin.add_properties_amount', ['id' => $product->id])}}"
                            class="btn btn-success">Nhập hàng</a>
                    </div>
                </form>
            </div>
        </div><!-- /.container-fluid -->
