                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Tên sản phẩm : {{$properties->product->name}} <p>Màu : {{$properties->color->name}}
                                    </p>
                                    <p>Size : {{$properties->size}}</p>
                                </td>
                                <td><input class="form-control quantity input-sm" option="1" cart="" rel=""
                                        name="amount" style="width:60px; text-align:center;padding-right:0px; "
                                        value="{{$amount}}" type="number" min="1"></td>
