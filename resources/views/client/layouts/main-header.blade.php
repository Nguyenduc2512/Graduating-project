                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('new_account')}}" enctype="multipart/form-data"
                                                    method="post">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger">
                                                                    {{$errors->first('confirm_pass')}} </span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <span class="text-danger"> {{$errors->first('avatar')}}
                                                                </span>
                                                                @endif
                                                            </div>
                                                    ...
                                                    <div class="col-md-6" style="margin: auto;">
                                                        <form action="{{route('login')}}" method="post"
                                                            ...
                                                            <a href="{{ route('password.request') }}"
                                                                data-target="#reset" role="dialog"
                                                                style="color: red;">Quên mật khẩu?</a>
                                            ...
                                            <form action="{{route('member.new_order')}}" method="post" id="form_order">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10" style="margin: auto">
                                                        <div class="title">
                                                            <h2 class="text_title"><span>Thông tin liên hệ giao
                                                                    hàng</span></h2>
                                                        </div>
                                                        <div class="form-group">
